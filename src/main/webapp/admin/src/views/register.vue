  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.18);borderRadius:15px">
        <h1 class="h1" style="color:rgba(64, 158, 255, 1);fontSize:28px;">房屋租赁系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="用户名" class="input" v-if="tableName=='huiyuan'">
...
export default {
  ...
  methods: {
    ...
    // 注册
    login() {
                                                      if((!this.ruleForm.yonghuming) && `huiyuan` == this.tableName){
        ...
        return
                                                                  ...
                                                                  if((!this.ruleForm.xingming) && `huiyuan` == this.tableName){
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20201217/ba285342942343738332ecd2dd3d1f1f.jpg");
		height: 100vh;
