          ...
          <el-form-item class="input" label="楼号" prop="louhao">
              <el-input v-model="ruleForm.louhao" 
                placeholder="楼号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="设施" prop="sheshi">
          <el-input v-model="ruleForm.sheshi" 
              placeholder="设施" clearable  :readonly="ro.sheshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="设施" prop="sheshi">
              <el-input v-model="ruleForm.sheshi" 
                placeholder="设施" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
