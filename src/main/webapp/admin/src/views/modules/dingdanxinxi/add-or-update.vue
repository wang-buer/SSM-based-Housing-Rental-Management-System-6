          ...
          <el-form-item class="input" v-if="ruleForm.zongjiage" label="总价格" prop="zongjiage">
              <el-input v-model="ruleForm.zongjiage" 
                placeholder="总价格" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="租房日期" prop="zufangriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.zufangriqi" 
                type="date"
                placeholder="租房日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zufangriqi" label="租房日期" prop="zufangriqi">
          ...
          <el-form-item class="input" label="租房时长" prop="zufangshizhang">
              <el-input v-model="ruleForm.zufangshizhang" 
                placeholder="租房时长" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="信息备注" prop="xinxibeizhu">
          <el-input v-model="ruleForm.xinxibeizhu" 
              placeholder="信息备注" clearable  :readonly="ro.xinxibeizhu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="信息备注" prop="xinxibeizhu">
              <el-input v-model="ruleForm.xinxibeizhu" 
                placeholder="信息备注" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  data() {
	...
	ispay : false,
            ...
            ruleForm: {
                  ...
                  zufangshizhang: [
                            { required: true, message: '租房时长不能为空', trigger: 'blur' },
                                    	                                                              ],
                  xinxibeizhu: [
                                    	                                                              ],
                  yonghuming: [
  ...
  computed: {
                                                                                                                                        zongjiage: {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          get: function () {
        return 0+parseFloat(this.ruleForm.zujin)+parseFloat(this.ruleForm.yajin) || ''
      }
    },
                                                                                                                                  },
  created() {
