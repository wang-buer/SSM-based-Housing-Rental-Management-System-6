          ...
          <el-form-item class="input" label="租房日期" prop="zufangriqi">
              <el-input v-model="ruleForm.zufangriqi" 
                placeholder="租房日期" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="租房时长" prop="zufangshizhang">
          <el-input v-model="ruleForm.zufangshizhang" 
              placeholder="租房时长" clearable  :readonly="ro.zufangshizhang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="租房时长" prop="zufangshizhang">
              <el-input v-model="ruleForm.zufangshizhang" 
                placeholder="租房时长" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="合同日期" prop="hetongriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.hetongriqi" 
                type="date"
                placeholder="合同日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.hetongriqi" label="合同日期" prop="hetongriqi">
            ...
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.hetongneirong" label="合同内容" prop="hetongneirong">
                    <span v-html="ruleForm.hetongneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zufangriqi = true;
            continue;
	            	            ...
	            	            if(o=='zufangshizhang'){
            this.ruleForm.zufangshizhang = obj[o];
	    this.ro.zufangshizhang = true;
            continue;
          }
	            	            if(o=='hetongriqi'){
