  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="押金" prop="yajin">
              <el-input v-model="ruleForm.yajin" 
                placeholder="押金" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="租房日期" prop="zufangriqi">
          <el-input v-model="ruleForm.zufangriqi" 
              placeholder="租房日期" clearable  :readonly="ro.zufangriqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="租房日期" prop="zufangriqi">
              <el-input v-model="ruleForm.zufangriqi" 
                placeholder="租房日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="合同日期" prop="hetongriqi">
          <el-input v-model="ruleForm.hetongriqi" 
              placeholder="合同日期" clearable  :readonly="ro.hetongriqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="合同日期" prop="hetongriqi">
              <el-input v-model="ruleForm.hetongriqi" 
                placeholder="合同日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="退房日期" prop="tuifangriqi">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tuifangriqi" label="退房日期" prop="tuifangriqi">
              <el-input v-model="ruleForm.tuifangriqi" 
                placeholder="退房日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="房屋评分" prop="fangwupingfen">
          <el-select v-model="ruleForm.fangwupingfen" placeholder="请选择房屋评分">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="房屋评分" prop="fangwupingfen">
	      <el-input v-model="ruleForm.fangwupingfen"
                placeholder="房屋评分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
          ...
          <el-form-item class="input" label="身份证" prop="shenfenzheng">
              <el-input v-model="ruleForm.shenfenzheng" 
                placeholder="身份证" readonly></el-input>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="房屋评价" prop="fangwupingjia">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.fangwupingjia" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.fangwupingjia" label="房屋评价" prop="fangwupingjia">
                    <span v-html="ruleForm.fangwupingjia"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	ispay : false,
            ...
            ruleForm: {
                  ...
                  fangwupingjia: [
                            { required: true, message: '房屋评价不能为空', trigger: 'blur' },
                                    	                                                              ],
                  yonghuming: [
                                    	                                                              ],
                  xingming: [
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yajin = true;
            continue;
	            	            ...
	            	            if(o=='zufangriqi'){
            this.ruleForm.zufangriqi = obj[o];
	    this.ro.zufangriqi = true;
            continue;
          }
	            	            if(o=='hetongriqi'){
            this.ruleForm.hetongriqi = obj[o];
	    this.ro.hetongriqi = true;
            continue;
          }
	            	            if(o=='tuifangriqi'){
	    ...
	    this.ro.fangwupingfen = true;
            continue;
	            	            ...
	            	            if(o=='fangwupingjia'){
            this.ruleForm.fangwupingjia = obj[o];
	    this.ro.fangwupingjia = true;
            continue;
          }
	            	            if(o=='yonghuming'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `tuifangpingjia/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.tuifangpingjiaCrossAddOrUpdateFlag = false;
                  this.parent.search();
